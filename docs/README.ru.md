...
## Проверенная совместимость с Codex

Этот релиз протестирован с portable IDE-расширением Codex `openai.chatgpt-26.825.51511` в Windows. Работа с другими версиями Codex, включая более новые и старые сборки, не гарантируется: изменения Responses-событий, состояния инструментов или diff-интерфейса могут потребовать обновления прокси.
